...
| **1:25–1:45** | *"Katılmıyorum diyelim — ve nedenini söyleyeyim."* **Reddet**'e bas, gerekçe kutusuna yaz: **"KAN-3'ü güncelleme, o bilerek açık kalacak."** → onayla (Enter). | Adım kırmızı "reddedildi" olur. Zaman çizelgesine yeni mesaj düşer: **Sen → Koordinatör:** gerekçen aynen. Ardından **Koordinatör → Jira Uzmanı:** adımı gerekçeye göre revize eder — KAN-3 parametrelerden çıkar, yeni adım tekrar onaya gelir. | **Gerekçe ajana ulaşıyor.** Bu bir "iptal" butonu değil, ajanla pazarlık. Reddin kendisi de iz kaydına yazıldı. |
| **1:45–2:05** | *"Şimdi doğru. Onaylıyorum."* Revize adımda **Onayla**'ya bas. Jira sekmesine geç (Cmd/Alt+Tab), panoda durumu değişen ticket'ı 2 sn göster, Relay'e dön. | Adım yeşile döner, sonuç JSON'u gelir. Jira panosunda ticket gerçekten taşınmış. Maliyet şeridi artmaya devam eder. | **Bu mock değil** — gerçek Jira, gerçek değişiklik. (Replay modundaysan bu sekme geçişini ATLA, bkz. §4.) |
